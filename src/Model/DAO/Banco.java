...
public class Banco {
    ...
    public static void inicia(){
        ...
        Cliente cliente1 = new Cliente(1, "Alan Figueiredo", 'M', "30/01/1995", 30212126, "abner.ba81@gmail.com", 5142487, "Rua jaboti 35 Canudos NH",  93300012);
        Cliente cliente2 = new Cliente(2, "Judite Oliveira", 'F', "30/08/1994", 30212127, "juditeoliveirapet@gmail.com", 5187745, "Rua campo bom 78 Centro NH",  93300045);
        ...
        Cliente cliente7 = new Cliente(7, "Marta de Souza", 'F', "25/03/1993", 302121292, "martasouzapet@gmail.com", 48237314, "Rua tesla 215 Canudos NH",  93352012);
        Cliente cliente8 = new Cliente(8, "Aline Ferrari", 'F', "04/03/1990", 30211451, "alineferraripet@gmail.com", 4753687, "Rua hyrule 32 Canudos NH",  933471447);
        Cliente cliente9 = new Cliente(9, "Samuel Coltinho", 'M', "09/02/1998", 30221189, "samuelcoltinhopet@gmail.com", 7542487, "Rua floresta 12 Canudos NH",  933004364);
        Cliente cliente10 = new Cliente(10, "Felipe Luis", 'M', "12/06/1999", 302112478, "felipeluispet@gmail.com", 84573647, "Rua marechal 1023 Canudos NH",  933000874);
